...
public class SeckillServiceImpl implements SeckillService
{
    ...
    @Autowired //@Resource
    private SuccessSeckilledDao successKilledDao;
...
//        Seckill seckill = redisDao.getSeckill(seckillId);
        ...
        if (seckill == null) {
            ...
            System.out.println("deao"+seckill);
        ...
        try{
            ...
            if (insertCount<=0)
            {
                ...
                if (updateCount<=0)
                {
                	...
                	SuccessSeckilled successKilled=successKilledDao.queryByIdWithSeckill(seckillId,userPhone);
